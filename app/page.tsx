    ...
    return (
        <main className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="max-w-3xl w-full">
                ...
                {/* Themes Preview */}
                <div className="glass-card rounded-2xl p-5 sm:p-6 lg:p-8 mb-6 sm:mb-8 animate-slide-up" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="text-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
                    <Link href="/review" className="btn-primary inline-flex items-center gap-2 sm:gap-3 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4">
                        {t('home.startReview')}
                        <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                        </svg>
                    </Link>
                    <p className="text-slate-400 text-xs sm:text-sm mt-3 sm:mt-4">{t('home.duration')}</p>
                </div>
            </div>
        </main>
    )
